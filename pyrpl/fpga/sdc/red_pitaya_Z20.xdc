...
create_clock -period 8.138 -name adc_clk [get_ports adc_clk_p_i]

set_input_delay -clock adc_clk 6.000 [get_ports adc_dat_a_i[*]]
set_input_delay -clock adc_clk 6.000 [get_ports adc_dat_b_i[*]]
